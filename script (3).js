...
// Tab switching, a sliding active-tab indicator, and
// data-driven Projects + Certifications sections.
//
...
const CERTIFICATIONS = [
  ...
  { name: "Lifeguarding / CPR / AED", issuer: "Professional Rescuer", url: null },
];
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // Placeholder card hinting where future projects will appear
  ...
  // Position indicator on initial load (after fonts/layout settle)
