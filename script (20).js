...
const ENGINEERING_PROJECTS = [
  {
    ...
    thumbnail: "images/etc-installed-in-airboat.jpg",
    description:
  ...
  },
  {
    ...
    thumbnail: "images/bike-fit-thumbnail.jpg",
    description:
  ...
  },
  {
    ...
    description:
      ...
      "— an inflatable shelter and casualty sled, rated from -40°F to " +
      "+120°F, that deploy in under 45 seconds and support 400+ lbs.",
    steps: [
      {
        title: "What It Is",
        ...
        description:
          ...
          "left, the CCP (Casualty Collection Point), a rapidly " +
          "deployable shelter. On the right, the CPU (Casualty Protection " +
          "Unit), an individual inflatable stretcher/sled. Both are rated " +
          "to operate from -40°F to +120°F.",
      },
      {
        title: "The CPU — Casualty Protection Unit",
        description:
          "The CPU is designed to get underneath an injured person and " +
          "begin protecting them almost immediately: it deploys in under " +
          "45 seconds, even with a patient already on the ground, and " +
          "weighs only about 15.5 lbs despite supporting over 400 lbs of " +
          "load. It can be inflated with a manual pump, compressed gas, " +
          "or a 12V source, and can be dragged, towed, or lifted once a " +
          "casualty is aboard. Inside, a suspended hammock system holds " +
          "the torso at roughly a 30° angle to reduce aspiration risk, " +
          "keeps the patient off the ground and away from pressure " +
          "points, and includes integrated fluid drainage. Five layers of " +
          "insulation give it an R-5 thermal rating, and a waterproof " +
          "outer skin allows it to cross open water or be used as a " +
          "pontoon.",
      },
      {
        title: "The CCP — Casualty Collection Point",
        description:
          "The CCP is a self-erecting shelter that turns a stabilized " +
          "casualty into a protected treatment space. It sets up in under " +
          "45 seconds with only 1-2 operators, and a single CCP can dock " +
          "up to four CPUs at once — scaling from a single-casualty " +
          "shelter to an organized triage point as needed. Double-walled " +
          "aluminized radiant barriers protect against temperatures from " +
          "-40°F to +120°F, and the structure is rated to withstand winds " +
          "up to 100 mph. Multiple entry and exit points keep casualty " +
          "flow efficient rather than funneling everyone through a single " +
          "doorway, and the frame is field-repairable with standard kits.",
      },
      {
      ...
      },
      {
        ...
        images: ["images/swift-field-test-cold.jpg", "images/swift-wind-testing.png"],
        description:
          "Both components use advanced materials — aluminized ripstop " +
          "nylon, Dyneema skins, and pack-raft-style fabrics — chosen to " +
          "balance durability against weight. Field testing was central " +
          "to validating those material choices rather than trusting the " +
          "design on paper alone. On the left, a CPU and CCP set up and " +
          "in use in actual sub-freezing field conditions. On the right, " +
          "a dedicated wind-testing rig — airboat engines driving airflow " +
          "against a wall built from the same materials — used to " +
          "validate the structure's 100 mph wind rating under " +
  ...
  },
  {
    ...
    description:
      ...
      "feedback — more details and build photos coming soon.",
    steps: [
      {
        title: "Overview",
        description:
...
most_common = word_counts.most_common(10)`,
      ...
      {
        title: "Key Findings",
        image: "images/moby-dick-word-frequency.png",
        description:
