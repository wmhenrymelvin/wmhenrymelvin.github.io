    ...
    steps: [
      {
        ...
        description:
          ...
          "body, so they're comfortable, efficient, and not straining a " +
          "joint in a way that leads to injury over time. Professionals " +
          "do this by measuring the angles your knee, hip, torso, and " +
          "arm form at key points in the pedal stroke and comparing them " +
          "to research-backed healthy ranges — but that usually means " +
          "paying a specialist with the right tools. Trying to check " +
          "your own fit from a phone video, without that equipment, " +
          "normally comes down to guessing — you're eyeballing angles by " +
          "eye with nothing to actually confirm you're right.",
      },
      {
        title: "What It Does",
        description:
