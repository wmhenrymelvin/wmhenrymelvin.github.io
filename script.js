    ...
    steps: [
      {
        ...
        description:
          ...
          "equipment. This project checks it from a single phone video " +
          "using two computer-vision models working together: a pose " +
          "model that tracks the specific joints on your body — knee, " +
          "hip, shoulder, elbow — frame by frame, and a more detailed " +
          "vision model that traces the full outline of your body so the " +
          "tracking still holds up through the motion blur of a full " +
          "pedal stroke. Once it has those points locked on, it measures " +
          "the angles they form and compares them against real bike-fit " +
          "industry ranges — the same targets a professional fitter " +
          "checks by hand — grading each one green, amber, or red.",
      },
      {
        title: "Watch It Track",
        video: "images/bike-fit-overlay.mp4",
        description:
          "This clip shows the tool running on my own pedal stroke, with " +
          "a color-coded skeleton tracking my knee, hip, shoulder, and " +
          "elbow live as I ride — not just a final number with no way to " +
          "check it.",
      },
      {
        title: "The Key Frame",
      ...
      },
      {
        ...
        description:
          ...
          "ffmpeg for H.264 re-encoding. The hard part was finding that " +
          "key frame reliably — knee angle is noisy frame-to-frame, so " +
          "instead of trusting one frame, the tool treats knee angle over " +
          "time as a signal, finds local maxima with a minimum spacing " +
          "constraint so it can't double-count a stroke, then takes the " +
          "median angle across every detected stroke.",
      },
      {
        title: "Results",
        description:
