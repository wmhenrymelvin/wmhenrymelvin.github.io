    ...
    steps: [
      ...
      },
      {
        ...
        description:
          ...
          "ran into problems, so we reworked it — see the update below.",
      },
      {
        title: "Updated Control Box",
        image: "images/etc-control-box-v2.jpg",
        description:
          "We upgraded the control box with a screen, an SD card reader, " +
          "and dedicated start, pause, and stop buttons, giving us real " +
          "start/pause/stop control over a test run instead of just a " +
          "single start button.",
      },
      {
        ...
        description:
          "Inside the same box: the relays, fuse block, and Arduino " +
          "wired up to run the gauges and handle the new start/pause/stop " +
          "controls.",
      },
      {
        title: "New Servo & Gearbox",
        image: "images/etc-servo-gearbox.jpg",
        description:
          "We also changed the servo layout, adding a gearbox to deliver " +
          "more torque, and redesigned the coupler/head mount so it could " +
          "properly hold the wire that pulls the throttle.",
      },
      {
        title: "Gearbox Mount, Close Up",
        image: "images/etc-gearbox-mount-closeup.jpg",
        description:
          "A closer look at the new gearbox mounted to the frame — you " +
          "can see how it sits isolated on rubber mounts and connects " +
          "down to the coupler that pulls the throttle wire.",
      },
      {
        title: "Limit Switches in Action",
        video: "images/etc-limit-switch.mp4",
        description:
          "We added limit switches to stop the throttle plate at its " +
          "travel limits. They're small enough that a still photo doesn't " +
          "really show them, so here's a clip instead — watch the " +
          "throttle plate hit the limit switch as it reaches full travel.",
      },
      {
        title: "Throttle Connection",
        image: "images/etc-throttle-connection.jpg",
        description:
          "This is where it all comes together: the wire from the servo " +
          "and gearbox attaches directly to the throttle linkage on the " +
          "engine, pulling it open and closed the same way a cable from a " +
          "gas pedal would.",
      },
      {
        title: "Installed in the Airboat",
        image: "images/etc-installed-in-airboat.jpg",
        description:
          "The full system installed and wired up in the engine bay, " +
          "ready for testing.",
      },
    ],
  },
